...
import com.zeal.mall.model.VO.OrderItemVO;
import com.zeal.mall.model.VO.OrderVO;
import com.zeal.mall.model.dao.CartMapper;
import com.zeal.mall.model.dao.OrderItemMapper;
import com.zeal.mall.model.dao.OrderMapper;
import com.zeal.mall.model.dao.ProductMapper;
import com.zeal.mall.model.pojo.Order;
import com.zeal.mall.model.pojo.OrderItem;
...
import com.zeal.mall.util.OrderCodeFactory;
//import com.zeal.mall.util.QRCodeGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public PageInfo listForCustomer(@RequestParam Integer pageNum, @RequestParam Integer pageSize){
        Integer userId = UserFilter.currentUser.getId();
...
////        try {
////            ip=InetAddress.getLocalHost().getHostAddress();//ip不一定准确
...
//    }
    ...
    @Override
    public void delivered(@RequestParam String orderNo){
        Order order = orderMapper.selectByOrderNo(orderNo);
        //查不到订单报错
        if (order==null){
            throw new ImoocMallException(ImoocMallExceptionEnum.NO_ORDER);
